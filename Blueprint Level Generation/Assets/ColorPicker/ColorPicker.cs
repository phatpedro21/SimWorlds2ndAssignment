...
public class ColorPicker : MonoBehaviour {
	...
	public void _DrawGUI () 
	{
		...
		closeCondition = isLeftMBtnClicked || (!rectFullSize.Contains(e.mousePosition)) && (e.isMouse && (e.type == EventType.MouseMove || e.type == EventType.MouseDown));
	...
	/*public void openToSelectColour()
	{
		openCondition = true;
		//receiver
	}*/
